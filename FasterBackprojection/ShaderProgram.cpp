...
ShaderProgram::ShaderProgram() : _handler(0), _linked(false)
...
bool ShaderProgram::setUniform(const std::string& name, GLfloat value) const
{
#if DEBUG_UNIFORMS	
...
bool ShaderProgram::setUniform(const std::string& name, GLint value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const GLuint value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const std::vector<glm::mat4>& values) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const glm::vec2& value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const glm::ivec2& value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const glm::uvec2& value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const glm::ivec3& value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const glm::vec4& value) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniform(const std::string& name, const std::vector<float>& values) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
...
bool ShaderProgram::setUniformBlock(const std::string& name, const GLuint bufferID) const
{
#if DEBUG_UNIFORMS	
	GLint location = glGetUniformLocation(_handler, name.c_str());
	...
	if (location >= 0)
	{
		glUniformBlockBinding(_handler, location, 0);

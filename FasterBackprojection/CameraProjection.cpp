...
{
	if (_cameraType < _cameraProjection.size())
	{
...
void CameraProjection::CameraProperties::zoom(float speed)
{
	//CameraProjection::_cameraProjection[this->_cameraType]->zoom(this, speed);
	CameraProjection::_cameraProjection[CameraProjection::PERSPECTIVE]->zoom(this, speed);
	_hasChanged = true;
}
